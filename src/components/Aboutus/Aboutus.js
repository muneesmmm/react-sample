    ...
    return (
        <div className="container">
            ...
            <div className="row justify-content-center ">
                    <div className="col-md-6 order-1 p-3 mt-5" data-aos="zoom-out-right" data-aos-duration="1000"  >
                    ...
                    <div className="col-md-6 order-2" data-aos="zoom-out-left" data-aos-duration="3000"  >
